...
\begin{figure}[htbp]
  \centering
  \includegraphics[scale=0.3]{Bilder/verzeichnisback.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[scale=0.8]{Bilder/UML_RI.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[scale=0.37]{Bilder/Code/schemasql.png}
  \includegraphics[scale=0.37]{Bilder/Code/migrationsql.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[scale=0.45]{Bilder/Code/serverts.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[scale=0.8]{Bilder/UML_SnipeIt.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[scale=0.5]{Bilder/Code/client.png} \vspace{2em}
  \includegraphics[scale=0.5]{Bilder/Code/sever.png}
