...
zunächst nicht sichergestellt werden konnten (\anfref{Q20}). Durch die
...
Die erarbeite Funktionalität Ft-VA-7 umfasst das Filtern von Materialen. Das
...
Entwürfe für diese Komponente erarbeitet \todo{Anhang}.
...
zu können, das erarbeitet Konzept in das Labormanagementsystem zu \todo{Pabst
