...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.65]{Bilder/level1.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.7]{Bilder/level2.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=1.4]{Bilder/level3.pdf}
...
Für das Reservierungsinterface werden ein Serverframework und eine
