...
näher erläutert (\ref{table:ft-b}).\todo{deutlicheren Bezug zu den Anforderungen herstellen}
...
Dies geschieht mittels Color-Coding.  \todo{Design-Entscheidungen begründen und nicht nur darstellen. D.h. hier vielleicht einen Satz dazu, warum du Color Coding als geeignete Variante dafür identifiziert hast }
...
bestätigt. \todo{Auch hier wieder die Frage - warum hast du diese Umsetzung gewählt? }
...
(\ref{table:ft-v}).\todo{deutlicheren Bezug zu den Anforderungen herstellen}
...
erstellt werden, um die Pflege zu erleichtern. \todo{Das hier verstehe ich noch nicht so ganz. Hier wären glaube ich zwei drei Sätze mehr ganz hilfreich}
...
Wesentlichen aus den folgenden drei Komponenten (\ref{fig:uml}): dem \textit{Snipe-IT Server}, dem
...
\todo[]{(Krause, 2022)}. Zusätzlich zu den bereits aufgeführten Eigenschaften wird Vue.js aufgrund
