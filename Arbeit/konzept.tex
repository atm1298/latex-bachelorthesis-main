...
bildet die Basis der Realisierung von Software-Systemen \todo{(Dumke, 2000)}. Diese besteht im
...
Teilkomponenten detaillierter dargestellt \todo{(Brown, 2021)}. 
...
Bestandteile und Wechselwirkungen zwischen diesen aufzuzeigen (Brown, 2021). Im Folgenden wird
der Container der XXXX genauer betrachtet \ref{fig:level3}.
