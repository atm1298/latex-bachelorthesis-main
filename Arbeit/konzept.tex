...
Die Grundlage der Auswahl, die im Rahmen dieser Arbeit eingesetzten
Frameworks, bilden die eingangs beschriebenen Anforderungen
(\ref{section:anforderung}). Dem Sysem wird vorausgesetzt, dass es sich um
eine Web-Anwendung mit mobilen Anwendung/Fokus im Fokus handelt
