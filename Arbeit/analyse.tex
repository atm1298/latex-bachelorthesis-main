...
Ausleihenden einnehmen. Die Rollen der Ausleihenden umfassen sowohl Bachelor als auch
Master Studierende, diese sind in \ref{table:a} dargestellt. Die IDs der Teilnehmenden werden als
...
Rahmen dieser Arbeit auf die Mitarbeitenden des \ac{imis} sowie die Studierenden der Medieninformatik an
...
Dies führt dazu, dass aufgrund von Unwissenheit wenig Assets ausgeliehen werden können (alle).
Durch die verschiedenen Forschungsgruppen am \ac{imis} und die damit verbundenen Labore, gibt es
...
klare Ansprechpartner:innen ersichtlich sind (V1,V3, V4, A1, A2, A3). 
...
Fällen wird auf irgendeinem Zettel unterschrieben (V1, V2, V3, V4), dies führt mitunter zu einer
...
(V3). Es ist unter anderem vorgekommen, dass angeschaffte aber verschwunden geglaubte Assets nach zwei
Jahren wieder gefunden wurden (V1, V2, V3).
...
Dringlichkeit des SnipeIT Companion für eine bessere Vorbereitung. So können Ausleihende mit mehr
...
besten Fall ist eine Übersicht mit Informationen wie: Name, Seriennummer, usw. sowie die dazugehörige
...
Assets, die längere Zeit nicht genutzt werden, müssen von Verleihenden gewartet werden. Dieses gerät in
...
dabei die meiste Zeit eingeschaltet, daher wäre ein System in Form einer Web-App denkbar sinnvoll (V1,V5).
...
Darauf aufbauend wird eine funktionale Anforderung erstellt (\ref{section:funktionale}). Abschließend
