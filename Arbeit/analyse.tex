...
festgestellt (\ref{table:ati}) \cite{attig_assessing_2017}. In beiden Gruppen konnten ledilich
geringe Unterschiede innerhalb der soziodemografischen Daten festgestellt werden. Neben diesen Daten
sind im Kontext der vorliegenden Arbeit insbesondere die Technikaffinität relevant. 
