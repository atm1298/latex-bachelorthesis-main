...
\begin{itemize}
        ...
        \item Keine einheitlichen Prozesse (von Forschungsgruppe zu Forschungsgruppe unterschiedliche) (V1, V2,V3)
        ...
        \item Was passiert, wenn es kaputt geht? Absicherung, Transparenz, bekannte Macken klar? -> nein (alle V)
        \item Häufgiges weiterverweisen, an andere Personen, weil kein direkter Ansprechpartner (V1, V3, V4, A1, A2)
        \item Mail schreiben, weil Risko zu hoch, das Asset schon weg ist (A3)
        \item Immer nachfragen = nervig (A6)
        \item Weiß nicht was für ein Gerät es genau ist,... nicht kompatible -> Auskunft fehlt (Selbstaneignung) (A3)
        ...
        \item Studierende kommen ohne wissen und fragen nach "Kamera" -> Nachfragen, was sie brauchen und helfen -> Gespräch komplex (V2)
...
Derzeit melden sich ein Studierenden bei Anliegen an eine bestimmte
