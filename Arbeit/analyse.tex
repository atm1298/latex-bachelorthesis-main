...
(genauere Definition der Benutzergruppen in \ref{section:benutzer}). Bei den Teilnehmenden
...
(Haupt-)Zuständigkeitsbereich der Verleihenden aufgeführt. Die Verleihenden der Assets können
gleichzeitig die Position eines Ausleihenden einnehmen. Die Rollen der Ausleihend befragten umfassen
sowohl Bachelorstudent als auch Masterstudenten, diese sind in \ref{table:a} dargestellt. Die IDs
der Teilnehmenden werden als Verweise in den folgenden Abschnitten verwendet\footnote{die mit *
gekennzeichneten Personen wurden gemeinsam interviewt}. Des Weiteren wurde mithilfe des \ac{ati}
das technische Interesse und Verständnis der Teilnehmenden festgestellt, sodass das
Reservierungstools entsprechend an die Benutzergruppen angepasst werden kann
\cite{attig_assessing_2017}. 

% Mit der Fomulierung aufpassen! WiMi und Administratives Personal gibt es nicht! Vorsicht
% Brauche ich das Alter?
\begin{table}[h]
    \centering
...
%- Zielgruppe festlegen: Beziehe mich Hauptsächlich auf die Ausleihenden, aus den und den Gründen.
...
Resultierend aus den Stakeholder-Interviews konnten zwei Benutzergruppen für das System erarbeitet
