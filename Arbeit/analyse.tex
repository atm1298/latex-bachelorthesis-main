...
\todo[inline]{Schaue mal in das Paper rein, da sind viele Vergleichsstichproben:
...
ihren soziodemografischen Daten kaum, \todo[]{Formulierung :D} dadurch das auch
...
ohne Wissen \todo{Was für Wissen, etwas genauer} ein Asset ausleihen
...
\section{Aufgabenanalyse}\todo[]{Würde es nicht mehr Sinn ergeben, erst die
        Aufgaben zu analysieren, um diese dann in der Problemanalyse zu
        referenzieren? Dann würde auch einiges an Doppelung entfallen}
...
\todo[]{Hier wäre der Tausch zwischen Aufgaben- und Problemanalyse sinnvoll.
        Dann wäre der Vorschlag: "Eine Übersicht der ausleihbaren Assets existiert
        nicht." In der Problemanalyse könnte man das Fehlen der Übersicht dann
        referenzieren und Doppelung vermeiden.}Wie bereits in der Problemanalyse
geschildert (\nameref{section:probleme-allgemein}), gibt es keine Übersicht über
...
dass keine langfristige Planung gewährleistet werden kann. \todo[]{Gehört das
        nicht eher in die Konzeption? Hier sollte man ja nur analysieren und nicht schon
        Lösungen konzipieren} Dies kann jedoch durch den SnipeIT Companion mittels eines
...
\subsubsection{Informelle Organisation}\todo[]{Ist das in meinem Kontext
        wirklich wichtig?} Aus informeller Sicht ist die Verbindung zwischen
...
\todo[]{etwas sehr waage oder :D. Was für andere Orte? }. Daher werden
