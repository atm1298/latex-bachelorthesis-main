...
\begin{center}
        ...
        \begin{tabular}{lp{0.85\textwidth}}
                \arrayrulecolor{maincolor}\hline
                \sffamily\color{maincolor}/R10/ & Das System ist eine Web-Anwendung. \\
                \sffamily\color{maincolor}/R20/ & Die Zielgruppe sind Mitarbeitende des IMIS und Studierende. \\
                \sffamily\color{maincolor}/R30/ & Die Zielgruppe teilt sich in zwei Nutzergruppen: die Verleihenden
                und Ausleihende von Assets. Die Definitionen der Nutzergruppen sind in Kapitel
                (\secref{section:benutzer}) zu finden. \\
                \sffamily\color{maincolor}/R40/ & Das System wird von Verleihenden sowohl im mobilen als auch im
                ...Kontext genutzt. \\
                \sffamily\color{maincolor}/R50/ & Die eingesetzte Software auf der Zielmaschine ist clientseitig ein
...
\begin{center}
        ...
        \begin{tabular}{lp{0.85\textwidth}}
                \arrayrulecolor{maincolor}\hline
                 \sffamily\color{maincolor}/K10/ & Das aktuelle Vorgehen umfasst keine Liste für Verleihende und
                Ausleihende. \\
                 \sffamily\color{maincolor}/K20/ & Es kommmt zu Doppelbeschaffungen. \\
                 \sffamily\color{maincolor}/K30/ & Es existieren von Forschungsgruppe zu Forschungsgruppe
...
\begin{center}
        ...
        \begin{tabular}{lp{0.85\textwidth}}
                \arrayrulecolor{maincolor}\hline
                 \sffamily\color{maincolor}/F10/  & Das System \textit{muss} Verleihenden und Ausleihenden die
                Möglichkeit bieten, eine Übersicht der Assets jederzeit einsehen zu können (A). \\
                 \sffamily\color{maincolor}/F20/  & Das System \textit{muss} XX die Möglichkeit bieten,  . \\
                 \sffamily\color{maincolor}/F30/  & Das System \textit{muss} XX die Möglichkeit bieten,  (A). \\
                 \sffamily\color{maincolor}/F40/  & Das System \textit{muss} XX relevante Informationen anzeigen, (A).
                \\
                 \sffamily\color{maincolor}/F50/  & Das System \textit{muss} XX die Möglichkeit geben,. \\
                 \sffamily\color{maincolor}/F60/  & Das System \textit{soll} die Möglichkeit bieten, individuelle und
                personalisierte Inhalte zu visualisieren -> Checkliste (A). \\
                 \sffamily\color{maincolor}/F70/  & Das System \textit{soll} daran erinnern, die Ausgeliehenen Assets
                zurückzubringen oder zu verlängern oder abzuholen (A). \\
                 \sffamily\color{maincolor}/F80/  & Das System \textit{soll} XX die Möglichkeit bieten, . \\
                 \sffamily\color{maincolor}/F90/  & Das System \textit{sollte in Zukunft} . \\
                 \sffamily\color{maincolor}/F100/ & Das System \textit{sollte in Zukunft} XX die Möglichkeit bieten,
                Informationen zu hinterlassen (A). \\
                 \sffamily\color{maincolor}/F110/ & Das System \textit{sollte in Zukunft} . \\
                \arrayrulecolor{maincolor}\hline
        \end{tabular}
\end{center}
...
\begin{center}
        ...
        \begin{tabular}{lp{0.85\textwidth}}
                ...
                sicherstellen. \\
                 \sffamily\color{maincolor}/Q30/ & Das System \textit{soll} modular strukturiert sein, damit Inhalte
                und Funktionalitäten effizient eingebunden werden können und das System einfach
                erweiterbar ist. \\
                 \sffamily\color{maincolor}/Q40/ & Das System \textit{soll} beim Zugriff über das Internet eine
                gesicherte Übertragung (bspw. \ac{HTTPS}) ermöglichen. \\
                 \sffamily\color{maincolor}/Q50/ & Das System \textit{soll} alle Benutzerinteraktionen in unter fünf
                Sekunden ausführen. \\
                \arrayrulecolor{maincolor}\hline
        \end{tabular}
\end{center}
