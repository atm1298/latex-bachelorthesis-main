...
wurde der organisatorische Kontext, des Systems festgehalten. Anschließen wurde der
zeitlich-räumliche Kontext eruiert.
...
haben teilweise unterschiedlichen Zugriff auf bestimmte Labor, welche die Assets beinhaltet.
...
Befinden sich Mitarbeitende im Büro, arbeiten sie an einem Desktop-Arbeitsplatz. Der Computer ist
dabei die meiste Zeit eingeschaltet, daher wäre ein System in beispielsweise Form einer Web-App
sinnvoll (...). Wenn Mitarbeitende das Büro verlassen, um ein Asset zu Verleihen, können sich
\ac{wimi} in verschiedenen Laboren aufhalten/befinden. Da der Ort der Nutzung variiert, liegt
ein mobiler Nutzungskontext vor, welcher beispielsweise durch die Nutzung einer Web-App auf dem
Smartphone ermöglicht werden kann (V1, V2, V , A).
