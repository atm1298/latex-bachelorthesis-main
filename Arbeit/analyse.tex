...
strukturiert und unter den einzelnen Analysepunkten zusammengefasst (\todo{Anhang})
...
Bei einer weiteren Recherche am 20.06.2022 mit Google Scholar wurde sich auf Plattformen mit
...
SD=0.48, N=9). Durch das Heranziehen zweier Vergleichsstichproben aus \citeA{franke_personal_2019}
...
geschildert (\nameref{section:probleme-allgemein}), gibt es keine Übersicht über ausleihbare Assets.
...
\begin{center}
        ...
        \begin{longtable}{lp{0.85\textwidth}} \arrayrulecolor{maincolor}\hline
                ...
                \ref{section:Nutzenden} unterscheiden und die dazugehörigen Zugriffsrechte
                sicherstellen.                                                                       \\
                ...
                \\
                \anfrow & Das System \textit{soll} alle Nutzendeninteraktionen in unter fünf Sekunden
                ausführen.                                                                           \\
                \arrayrulecolor{maincolor}\hline
        \end{longtable}
\end{center}
