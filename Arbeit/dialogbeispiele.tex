...
\begin{figure}[p]
    ...
    \includegraphics[scale=0.19]{Bilder/Dialgobeispiel/mit datum .png}
...
\begin{figure}[p]
    \centering
    \includegraphics[scale=0.19]{Bilder/Dialgobeispiel/datumänderung.png}
    \includegraphics[scale=0.19]{Bilder/Dialgobeispiel/Bestätigung.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.2]{Bilder/Dialgobeispiel/laufende nach änderung.png}
    \includegraphics[scale=0.2]{Bilder/Dialgobeispiel/Datum ändern 2.png}
...
\begin{figure}[h]
    ...
    \includegraphics[scale=0.2]{Bilder/Dialgobeispiel/Zurück.png}
